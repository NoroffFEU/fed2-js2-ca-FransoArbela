import{B as m}from"./main-CB5Bi5DI.js";import{r as l,a as u}from"./read-CNdrJs85.js";import{a as d}from"./authGuard-BjwX1WRu.js";d();function p(){f(),y()}function f(){l(14,1).then(e=>{const t=document.querySelector(".posts");e.data.forEach(o=>{const n=v(o);t.appendChild(n)})})}function v(e){const t=document.createElement("div");t.classList.add("post"),t.setAttribute("id",e.id);const o=e._count.comments||0,n=e._count.reactions||0,c=e.reactions.filter(s=>s.count>0).map(s=>s.symbol).join(""),r=g(e.comments),i=h(e.media?.url,e.title);return t.innerHTML=`
