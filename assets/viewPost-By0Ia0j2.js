import{a as p}from"./authGuard-OOVH_Tj-.js";import{b as g}from"./read-BAsoaHjc.js";import{r as u}from"./read-mlms9NGE.js";import"./constants-X-ayW_43.js";p();const v=localStorage.getItem("profile"),f=JSON.parse(v),h=f.name,d=new URLSearchParams(window.location.search),$=d.get("id"),E=d.get("username");let n="";h===E&&(n=`<div class="edit-btn">
  <button></button>
