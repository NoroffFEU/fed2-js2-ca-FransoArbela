import{a as p}from"./authGuard-OOVH_Tj-.js";import{b as g}from"./read-Dx5mNkXq.js";import{r as u}from"./read-DgAHPANw.js";import"./main-Drz9Ix83.js";p();const v=localStorage.getItem("profile"),f=JSON.parse(v),h=f.name,d=new URLSearchParams(window.location.search),$=d.get("id"),E=d.get("username");let n="";h===E&&(n=`<div class="edit-btn">
  <button></button>
